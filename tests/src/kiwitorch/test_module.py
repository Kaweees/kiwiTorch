...
# as shown at https://kiwitorch.github.io/modules.html
# and checks that its properties work.


class ModuleA1(kiwitorch.Module):
    def __init__(self) -> None:
        super().__init__()
        self.p1 = kiwitorch.Parameter(5)
        self.non_param = 10
        self.a = ModuleA2()
        self.b = ModuleA3()


class ModuleA2(kiwitorch.Module):
    def __init__(self) -> None:
        super().__init__()
        self.p2 = kiwitorch.Parameter(10)


class ModuleA3(kiwitorch.Module):
    def __init__(self) -> None:
        super().__init__()
        self.c = ModuleA4()


class ModuleA4(kiwitorch.Module):
    def __init__(self) -> None:
        super().__init__()
        self.p3 = kiwitorch.Parameter(15)
...
class Module1(kiwitorch.Module):
    def __init__(self, size_a: int, size_b: int, val: float) -> None:
        super().__init__()
        self.module_a = Module2(size_a)
        self.module_b = Module2(size_b)
        self.parameter_a = kiwitorch.Parameter(val)


class Module2(kiwitorch.Module):
    def __init__(self, extra: int = 0) -> None:
        super().__init__()
        self.parameter_a = kiwitorch.Parameter(VAL_A)
        self.parameter_b = kiwitorch.Parameter(VAL_B)
...
class Module3(kiwitorch.Module):
    def __init__(self) -> None:
        super().__init__()
        self.parameter_a = kiwitorch.Parameter(VAL_A)
...
class ModuleRun(kiwitorch.Module):
